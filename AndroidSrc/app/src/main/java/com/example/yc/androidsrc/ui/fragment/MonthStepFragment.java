...
public class MonthStepFragment extends Fragment {
    ...
    private List<String> dateList; // 最近30天
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_month_step, container, false);
    ...
    public void drawLineChart() {
        ...
        lineChart.setExtraOffsets(0, 0, 0, 10); // 设置图表距离上下左右的距离
        // 设置XY轴动画效果和属性
        ...
        xAxis.setValueFormatter(new AxisValueFormatter() {
            ...
            public String getFormattedValue(float value, AxisBase axis) {
                String tradeDate = dateList.get((int) value);
                return DateUtil.formatDate4(tradeDate);
            }
